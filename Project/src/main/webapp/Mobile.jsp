                ...
                <div class="container">
                    <div class="item">
                        <div class="slide_container">
                            <div class="slide">
                                ...
                                <ul>
                                    <li>
                                        <div class="title">
                                            <a href="#"><i class="fas fa-mobile-alt"></i>1</a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="title">
                                            <a href="#"><i class="fas fa-mobile-alt"></i>2</a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="title">
                                            <a href="#"><i class="fas fa-mobile-alt"></i>3</a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="title">
                                            <a href="#"><i class="fas fa-mobile-alt"></i>4</a>
                                        </div>
                                    </li>
                                </ul>
                                <p class="bullet">
                            ...
                            <div class="popular_game">
                                <strong class="title"><i class="fas fa-mobile-alt"></i>모바일 게임 인기 순위</strong>
                                <ol>
                                    <c:forEach var="dto" items="${mRankList}">
                                    <li>
                                    	<div class="rank_list">
                        ...
                        <div class="board_container"> 
                            <div class="board">
                                <div class="title">
                                    <a href="board.do?aCode=pc&&bCode=002"><i class="fas fa-mobile-alt"></i>모바일 뉴스</a>
                                </div>
                                <div class="side_article">
                                <ul class="side_ul">
                                    <c:forEach var="dto" items="${mNewsList1}">
                                    <li>
                                ...
                                <ul class="side_ul">
                                    <c:forEach var="dto" items="${mNewsList2}">
                                    <li>
                                    	<div class="article_list">
                                        <a class="text_over" href="view.do?no=${dto.no}">
                                        <c:choose>
                            ...
                            <div class="board">
                                ...
                                <ul class="one_ul">
                                    <c:forEach var="dto" items="${mUserNewsList}">
                                    <li>
                                    	<div class="article_list">
                                        <a class="text_over" href="view.do?no=${dto.no}">
                                        <c:choose>
                            ...
                            <div class="board">
                                <div class="title">
                                    <a href="board.do?bCode=0015"><i class="fas fa-mobile-alt"></i>모바일 유저 게시판</a>
                                </div>
                                <ul class="one_ul">
                                    <c:forEach var="dto" items="${mUserBoardList}">
                                    <li>
                                    	<div class="article_list">
                            ...
                            <div class="board">
                                <div class="title">
                                    <a href="#"><i class="fas fa-mobile-alt"></i>모바일 게임 게시판 목록</a>
                                </div>
                                <ul class="board_ul">
                                    <c:forEach var="dto" items="${mCategoryBoardList}">
                                    <li>
                                    	<div class="article_list">
                                        <a class="text_over" href="board.do?bCode=${dto.board_code}">${dto.board_name}</a>										
										</div>
