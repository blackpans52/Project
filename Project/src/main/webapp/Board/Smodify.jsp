                    ...
                    <div class="item">
                        ...
                        <form action="modifyOK.do?no=${articleInfo.no}" method="post">
                        	<table class="write_table">
                        		<tr>
                        			<td><label for="title">제목</label><input type="text" name="title" id="title" size="45" placeholder="45자 제한"
                        			value="${articleInfo.title}" required></td>
                        		</tr>                                
                                <tr>
                                    <td>
                        ...
                        <div class="board_bottom_bar">
                            <div class="bottom_button_bar">
                                <button class="write_button" type="submit" style="justify-self: end;"><i class="fas fa-pencil-alt"></i>수정</button>
