                    ...
                    <div class="item">
                        <div class="slide_container">
                            ...
                            <div class="popular_game">
                                <strong class="title"><i class="fab fa-xbox"></i>Xbox 게임 인기 순위</strong>
                                <ol>
                                    <c:forEach var="dto" items="${xRankList}">
                                    <li>
                                    	<div class="rank_list">
                        ...
                        <div class="board_container"> 
                            <div class="board">
                                <div class="title">
                                    <a href="board.do?aCode=xbox&&bCode=002"><i class="fab fa-xbox"></i>Xbox 뉴스</a>
                                </div>
                                <div class="side_article">
                                <ul class="side_ul">
                                    <c:forEach var="dto" items="${xNewsList1}">
                                    <li>
                                ...
                                <ul class="side_ul">
                                    <c:forEach var="dto" items="${xNewsList2}">
                                    <li>
                                    	<div class="article_list">
                                        <a class="text_over" href="view.do?no=${dto.no}">
                                        <c:choose>
                            ...
                            <div class="board">
                                <div class="title">
                                    <a href="board.do?bCode=004"><i class="fab fa-xbox"></i>Xbox 유저정보</a>
                                </div>
                                <ul class="one_ul">
                                    <c:forEach var="dto" items="${xUserNewsList}">
                                    <li>
                                    	<div class="article_list">
                                        <a class="text_over" href="view.do?no=${dto.no}">
                                        <c:choose>
                            ...
                            <div class="board">
                                <div class="title">
                                    <a href="board.do?bCode=0013"><i class="fab fa-xbox"></i>Xbox 유저 게시판</a>
                                </div>
                                <ul class="one_ul">
                                    <c:forEach var="dto" items="${xUserBoardList}">
                                    <li>
                                    	<div class="article_list">
                            ...
                            <div class="board">
                                <div class="title">
                                    <a href="#"><i class="fab fa-xbox"></i>Xbox 게임 게시판 목록</a>
                                </div>
                                <ul class="board_ul">
                                    <c:forEach var="dto" items="${xCategoryBoardList}">
                                    <li>
                                    	<div class="article_list">
                                        <a class="text_over" href="board.do?bCode=${dto.board_code}">${dto.board_name}</a>										
										</div>
