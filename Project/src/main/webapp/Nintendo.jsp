                ...
                <div class="container">
                    <div class="item">
                        <div class="slide_container">
                            <div class="slide">
                                ...
                                <ul>
                                    <li>
                                        <div class="title">
                                            <i class="fas fa-toggle-on"></i>Nintendo 신작
                                        </div>
                                        <a class="new_game_img" href="#" style="background-image: url(Image/kurby.jpg)"></a>
                                    </li>
                                    <li>
                                        <div class="title">
                                            <i class="fas fa-toggle-on"></i>Nintendo 신작
                                        </div>
                                        <a class="new_game_img" href="#" style="background-image: url(Image/triangle.jpg)"></a>
                                    </li>
                                </ul>
                                <p class="bullet">
                            ...
                            <div class="popular_game">
                                <strong class="title"><i class="fas fa-toggle-on"></i>Nintendo 게임 인기 순위</strong>
                                <ol>
                                    <c:forEach var="dto" items="${nRankList}">
                                    <li>
                                    	<div class="rank_list">
                        ...
                        <div class="board_container"> 
                            <div class="board">
                                <div class="title">
                                    <a href="board.do?aCode=nintendo&&bCode=002"><i class="fas fa-toggle-on"></i>Nintendo 뉴스</a>
                                </div>
                                <div class="side_article">
                                <ul class="side_ul">
                                    <c:forEach var="dto" items="${nNewsList1}">
                                    <li>
                                ...
                                <ul class="side_ul">
                                    <c:forEach var="dto" items="${nNewsList2}">
                                    <li>
                                    	<div class="article_list">
                                        <a class="text_over" href="view.do?no=${dto.no}">
                                        <c:choose>
                            ...
                            <div class="board">
                                <div class="title">
                                    <a href="board.do?bCode=004"><i class="fas fa-toggle-on"></i>Nintendo 유저정보</a>
                                </div>
                                <ul class="one_ul">
                                    <c:forEach var="dto" items="${nUserNewsList}">
                                    <li>
                                    	<div class="article_list">
                                        <a class="text_over" href="view.do?no=${dto.no}">
                                        <c:choose>
                            ...
                            <div class="board">
                                <div class="title">
                                    <a href="board.do?bCode=0012"><i class="fas fa-toggle-on"></i>Nintendo 유저 게시판</a>
                                </div>
                                <ul class="one_ul">
                                    <c:forEach var="dto" items="${nUserBoardList}">
                                    <li>
                                    	<div class="article_list">
                            ...
                            <div class="board">
                                <div class="title">
                                    <a href="#"><i class="fas fa-toggle-on"></i>Nintendo 게임 게시판 목록</a>
                                </div>
                                <ul class="board_ul">
                                    <c:forEach var="dto" items="${nCategoryBoardList}">
                                    <li>
                                    	<div class="article_list">
                                        <a class="text_over" href="board.do?bCode=${dto.board_code}">${dto.board_name}</a>										
										</div>
