...
<%@ include file="/guide_bar.jsp"%>
            ...
            <div id="main_contents">
                <div class="container">
                    ...
                    <div class="item">
                        ...
                        <form action="modifyOK.do?no=${articleInfo.no}" method="post">                      
                        	<table class="write_table">
                        		<tr>
                        			<td><label for="title">제목</label><input type="text" name="title" id="title" size="45" 
                        			value="${articleInfo.title}" placeholder="45자 제한"></td>
                        		</tr>
                        		<tr>
                        			<c:choose>
                        			<c:when test="${boardInfo.board_code eq '002'}">
                        			<td>
                        				<span>구분</span>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <p>※ 기사 본문에 해당하는 한 문단을 먼저 작성해 주세요.</p>
                                        </div>
                                    </td>
                                </tr>
                        		<tr>
                        ...
                        <div class="board_bottom_bar">
                            <div class="bottom_button_bar">
                                <button type="submit" style="justify-self: end;"><i class="fas fa-pencil-alt"></i>수정</button>
  ...
  <script>
  	const target = document.getElementById("${articleInfo.article_category}");  	
